...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthService.LoginClientPost401Response();
  });
  ...
  describe('LoginClientPost401Response', function() {
    it('should create an instance of LoginClientPost401Response', function() {
      // uncomment below and update the code to test LoginClientPost401Response
      //var instance = new AuthService.LoginClientPost401Response();
      //expect(instance).to.be.a(AuthService.LoginClientPost401Response);
    });
